...
set label "T16" at 6.9, 15300 font "Helvetica,16" textcolor rgb '#0000FF'
set label "T8" at 4.8, 15200 font "Helvetica,16" textcolor rgb '#0000FF'
set label "T4" at 3.2, 15000 font "Helvetica,16" textcolor rgb '#0000FF'
set label "T2" at 1.7, 14800 font "Helvetica,16" textcolor rgb '#0000FF'

# Labels for the Red (H) curves
set label "H16" at 13.0, 15390 font "Helvetica,16" textcolor rgb '#FF0000'
set label "H8" at 11.0, 15550 font "Helvetica,16" textcolor rgb '#FF0000'
set label "H4" at 8.2, 15650 font "Helvetica,16" textcolor rgb '#FF0000'
set label "H2" at 4.7, 15750 font "Helvetica,16" textcolor rgb '#FF0000'
