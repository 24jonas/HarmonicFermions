...
set label "T16" at 14.0, 4880 font "Helvetica,16" textcolor rgb '#0000FF'
set label "T8" at 12.0, 4850 font "Helvetica,16" textcolor rgb '#0000FF'
set label "T4" at 8.0, 4800 font "Helvetica,16" textcolor rgb '#0000FF'
set label "T2" at 3.8, 4800 font "Helvetica,16" textcolor rgb '#0000FF'

# Labels for the Red (H) curves
# set label "H16" at 13.0, 4930 font "Helvetica,16" textcolor rgb '#FF0000'
set label "H8" at 12.8, 4880 font "Helvetica,16" textcolor rgb '#FF0000'
set label "H4" at 11.0, 4930 font "Helvetica,16" textcolor rgb '#FF0000'
set label "H2" at 7.7, 4950 font "Helvetica,16" textcolor rgb '#FF0000'
