...
set label "T16" at 13.0, 941 font "Helvetica,16" textcolor rgb '#0000FF'
set label "T8" at 12.0, 935 font "Helvetica,16" textcolor rgb '#0000FF'
set label "T4" at 10.0, 922 font "Helvetica,16" textcolor rgb '#0000FF'
set label "T2" at 6.0, 910 font "Helvetica,16" textcolor rgb '#0000FF'

# Labels for the Red (H) curves
set label "H16" at 13.0, 952 font "Helvetica,16" textcolor rgb '#FF0000'
set label "H8" at 12.0, 952 font "Helvetica,16" textcolor rgb '#FF0000'
set label "H4" at 10.0, 952 font "Helvetica,16" textcolor rgb '#FF0000'
set label "H2" at 7.0, 952 font "Helvetica,16" textcolor rgb '#FF0000'
