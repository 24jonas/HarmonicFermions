...
set label "T^{4A}" at 7, 4998.5 font "Helvetica,18" textcolor rgb "#9D00FF"
set label "H^{4A}" at 13, 5000.5 font "Helvetica,18" textcolor rgb "#FF6E0D"
...
set label "T^{4A}" at 0.38, 0.30 font "Helvetica,18" textcolor rgb "#9D00FF"
set label "H^{4A}" at 0.04, 0.05 font "Helvetica,18" textcolor rgb "#FF6E0D"
