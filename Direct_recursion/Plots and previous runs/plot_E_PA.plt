...
set label "T16" at 6.0, 935 font "Helvetica,20" textcolor rgb '#0000FF'
set label "T8" at 4.0, 925 font "Helvetica,20" textcolor rgb '#0000FF'
set label "T4" at 2.5, 915 font "Helvetica,20" textcolor rgb '#0000FF'
set label "T2" at 0.5, 905 font "Helvetica,20" textcolor rgb '#0000FF'

# Labels for the Red (H) curves
set label "H16" at 11.0, 952 font "Helvetica,20" textcolor rgb '#FF0000'
set label "H8" at 6.3, 952 font "Helvetica,20" textcolor rgb '#FF0000'
set label "H4" at 3.1, 954 font "Helvetica,20" textcolor rgb '#FF0000'
set label "H2" at 2.2, 972 font "Helvetica,20" textcolor rgb '#FF0000'
...
plot 'data_comp_ham _N64 _D3 _PA.csv' using 1:2 with lines ls 6, \
     ''                 using 1:3 with lines ls 5, \
     ''                 using 1:4 with lines ls 4, \
	 ''					using 1:5 with lines ls 3, \
     'data_comp_thermo _N64 _D3 _PA.csv' using 1:2 with lines ls 12, \
