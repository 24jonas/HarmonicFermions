...
set encoding utf8
set title "PA propagator, n=1,000,000, d=2, N=[2,4,8,16]" offset 0.1,-0.8
set xlabel "T"
set ylabel "C_v/n"
...
#set label "T16" at 1.5-1, 500 font "Helvetica,20" textcolor rgb '#0000FF'
set label "T8" at 2.1, 500 font "Helvetica,20" textcolor rgb '#0000FF'
set label "T4" at 2.55, 500 font "Helvetica,20" textcolor rgb '#0000FF'
set label "T2" at 3.05, 500 font "Helvetica,20" textcolor rgb '#0000FF'

# Labels for the Red (H) curves
#set label "H16" at 1.5, -500 font "Helvetica,20" textcolor rgb '#FF0000'
set label "H8" at 2.1, -500 font "Helvetica,20" textcolor rgb '#FF0000'
set label "H4" at 2.55, -500 font "Helvetica,20" textcolor rgb '#FF0000'
set label "H2" at 3.05, -500 font "Helvetica,20" textcolor rgb '#FF0000'
...
plot 'data_Cv_H_n1000000_w1_0.csv' using 1:2 with lines ls 6, \
     ''                 using 1:3 with lines ls 5, \
     ''                 using 1:4 with lines ls 4, \
     'data_Cv_T_n1000000_w1_0.csv' using 1:2 with lines ls 12, \
