...
set label "T16" at 1.5, 2.1 font "Helvetica,20" textcolor rgb '#0000FF'
set label "T8" at 2.1, 2.1 font "Helvetica,20" textcolor rgb '#0000FF'
set label "T4" at 2.55, 2.1 font "Helvetica,20" textcolor rgb '#0000FF'
set label "T2" at 3.05, 2.1 font "Helvetica,20" textcolor rgb '#0000FF'

# Labels for the Red (H) curves
set label "H16" at 1.5, -0.1 font "Helvetica,20" textcolor rgb '#FF0000'
set label "H8" at 2.1, -0.1 font "Helvetica,20" textcolor rgb '#FF0000'
set label "H4" at 2.55, -0.1 font "Helvetica,20" textcolor rgb '#FF0000'
set label "H2" at 3.05, -0.1 font "Helvetica,20" textcolor rgb '#FF0000'
...
plot 'data_Cv_H_n300_w1_0.csv' using 1:2 with lines ls 6, \
     ''                 using 1:3 with lines ls 5, \
     ''                 using 1:4 with lines ls 4, \
	 ''					using 1:5 with lines ls 3, \
     'data_Cv_T_n300_w1_0.csv' using 1:2 with lines ls 12, \
