...
set label "T16" at 6.2, 4840 font "Helvetica,16" textcolor rgb '#0000FF'
set label "T8" at 4.3, 4775 font "Helvetica,16" textcolor rgb '#0000FF'
...
set label "H8" at 6.2, 4940 font "Helvetica,16" textcolor rgb '#FF0000'
set label "H4" at 2.8, 4950 font "Helvetica,16" textcolor rgb '#FF0000'
set label "H2" at 2.2, 5050 font "Helvetica,16" textcolor rgb '#FF0000'
...
plot 'data_comp_ham _N300 _D2 _PA.csv' using 1:2 with lines ls 6, \
     ''                 using 1:3 with lines ls 5, \
     ''                 using 1:4 with lines ls 4, \
	 ''					using 1:5 with lines ls 3, \
     'data_comp_thermo _N300 _D2 _PA.csv' using 1:2 with lines ls 12, \
