...
with open("temp_polyconv.py", "w") as f:
    ...
    f.write(code3)
    f.write("\n")
    f.write("res = plot_logZ_and_fd_multiN(tau_start=0.1, tau_end=1.0, tau_step=0.5, n=7, d=2, N_list=[1, 4], show_logZ=False, show_fd=False, store_all_n=True)\n")
