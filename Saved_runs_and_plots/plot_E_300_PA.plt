...
set encoding utf8
set title "n=300, d=2, N=[2,4,8,16]" offset 0.1,-0.8
set xlabel "{{/Symbol t}"
set ylabel "E"
...
plot 'plot_data_n300_w1_0_H.csv' using 1:2 with lines ls 6, \
     ''                 using 1:3 with lines ls 5, \
     ''                 using 1:4 with lines ls 4, \
	 ''					using 1:5 with lines ls 3, \
     'plot_data_n300_w1_0_T.csv' using 1:2 with lines ls 12, \
