...
plot 'data_comp_ham _N50 _D2 _FA.csv' using 1:2 with lines ls 6, \
     ''                 using 1:3 with lines ls 5, \
     ''                 using 1:4 with lines ls 4, \
	 ''					using 1:5 with lines ls 3, \
     'data_comp_thermo _N50 _D2 _FA.csv' using 1:2 with lines ls 12, \
     ''                   using 1:3 with lines ls 11, \
     ''                   using 1:4 with lines ls 10, \
	 ''					  using 1:5 with lines ls 9, \
     'data_comp_exact _N50 _D2 _FA.csv'   using 1:2 with lines ls 13 # <-- EDIT THIS FILENAME
